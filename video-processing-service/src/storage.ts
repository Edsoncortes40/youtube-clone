...
const processedVideoBucketName = "edson-yt-processed-videos";
 ...
 * @param processedVideoName - The name fo the file to convert to {@link localProcessedVideoPath}.
...
export function convertVideo(rawVideoName: string, processedVideoName: string){
    return new Promise<void>((resolve, reject) => {
        ...
        .on('end', function() {
            console.log("Video Processing Finished Successful!");
            resolve();
        })
 ...
 * into the {@link processedVideoBucketName} folder.
